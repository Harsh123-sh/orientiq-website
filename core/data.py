...
SERVICES = [
    ...
    },
    {
        ...
        "short": "Cloud-ready systems designed for reliability, visibility, and efficient scaling as your product or operations grow.",
        "icon": "cloud",
        "features": [
        ...
        "problems": [
            "Infrastructure is too fragile for growing demand",
            "Deployments are slow or error-prone",
            "Teams lack visibility into application health and performance",
            "The environment is difficult to manage as the system grows",
        ],
        "tech": ["AWS", "Azure", "GCP", "Docker", "Kubernetes", "Terraform", "GitHub Actions"],
        "benefits": [
            "More reliable deployment and operations",
            "Better visibility into health and performance",
            "Improved consistency across environments",
            "A platform that grows with your business",
        ],
        "use_cases": [
            "Cloud migration projects",
            "Production hosting for web apps and APIs",
            "Multi-environment deployment management",
            "Infrastructure modernization and scaling",
        ],
        "process": [
            {"number": "01", "title": "Assessment", "description": "Review the current environment, workloads, growth needs, and operations requirements."},
            {"number": "02", "title": "Architecture", "description": "Define the cloud environment, infrastructure patterns, and target operating model."},
            {"number": "03", "title": "Design", "description": "Plan deployment workflows, monitoring, access controls, and scaling strategy."},
            {"number": "04", "title": "Build", "description": "Implement infrastructure automation, environment setup, and deployment pipelines."},
            {"number": "05", "title": "Launch", "description": "Deploy the environment, validate production readiness, and confirm monitoring coverage."},
            {"number": "06", "title": "Optimize", "description": "Use real usage and cost data to refine infrastructure, improve reliability, and scale efficiently."},
        ],
        "faqs": [
            {
                "q": "Do you work across multiple cloud providers?",
                "a": "Yes. We evaluate the right option based on your workload, existing commitments, team expertise, and long-term product needs.",
            },
            {
                "q": "Can you improve existing infrastructure without a full rebuild?",
                "a": "Yes. We can modernize and stabilize your environment in phases, starting with the biggest operational pain points and scaling gradually.",
            },
        ],
    },
    {
